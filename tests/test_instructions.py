...
def test_build_spl_create_account_instructions() -> None:
    context: entropy.Context = fake_context()
    wallet: entropy.Wallet = fake_wallet()
    token: entropy.Token = fake_token()
    actual = entropy.build_spl_create_account_instructions(context, wallet, token)
...
def test_build_spl_create_associated_account_instructions() -> None:
    ...
    wallet: entropy.Wallet = fake_wallet()
    token: entropy.Token = fake_token()
    actual = entropy.build_spl_create_associated_account_instructions(
...
def test_build_spl_transfer_tokens_instructions() -> None:
    ...
    actual = entropy.build_spl_transfer_tokens_instructions(
...
def test_build_spl_close_account_instructions() -> None:
    ...
    actual = entropy.build_spl_close_account_instructions(context, wallet, address)
    assert actual is not None
    assert len(actual.signers) == 0
    assert len(actual.instructions) == 1
    assert actual.instructions[0] is not None
...
def test_build_serum_create_openorders_instructions() -> None:
    ...
    actual = entropy.build_serum_create_openorders_instructions(context, wallet, market)
    assert actual is not None
    assert len(actual.signers) == 1
    assert len(actual.instructions) == 1
    assert actual.instructions[0] is not None
...
def test_build_serum_place_order_instructions() -> None:
    ...
    order_type: entropy.OrderType = entropy.OrderType.IOC
    ...
    actual = entropy.build_serum_place_order_instructions(
        context,
        wallet,
        market,
        source,
...
def test_build_serum_consume_events_instructions() -> None:
    ...
    limit: int = 64
    actual = entropy.build_serum_consume_events_instructions(
...
def test_build_serum_settle_instructions() -> None:
    ...
    actual = entropy.build_serum_settle_instructions(
        context,
        wallet,
        market,
        open_orders_address,
