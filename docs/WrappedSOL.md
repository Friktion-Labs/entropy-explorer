...
(Note: commands in this page assume you have set up a `entropy-explorer` command similar to how it's done in the [Quickstart](../Quickstart.md).)
...
```
# entropy-explorer group-balances --group-name BTC_ETH_SOL_SRM_USDC
...
```
# entropy-explorer show-wrapped-sol
...
```
# entropy-explorer wrap-sol --quantity 1
...
```
# entropy-explorer unwrap-sol --quantity 1
...
```
# entropy-explorer close-wrapped-sol-account --address 4dqnZ8MgT1AZksAixHha117DVPEBUJZ89V5MAgoYmzh9
